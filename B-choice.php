...
<div class="menu-area">
<li ><a href="B&O-choice.php">Back</a> </li>
</div>
<div class="loginbox"><br/>
<img src="images/user.png" class="user" >
<h1>Login Here</h1>
<form action='B-choice.php' method='post'>
	<p> User ID</p>
...
$check_query="SELECT * FROM b_collector WHERE uniqueID='$Username' AND password='$Pass' ";
...
if(mysqli_num_rows($run)>0){
	...
	echo "<script>window.open('collection-reg.php','_SELF')</script>";
}
else
