	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<h2> BBOT| Patient Reset Password</h2>
				</div>
					...
					<form class="form-login" name="passwordreset" method="post" onSubmit="return valid();">
						<fieldset>
							...
							<p>
								...
								<span style="color:red;"><?php echo $_SESSION['errmsg']; ?><?php echo $_SESSION['errmsg']="";?>
								</p>
...
<i class="fa fa-lock"></i> </span>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> BBOTS</span>. <span>All rights reserved</span>
					</div>
