              ...
              <div class="col-lg-8 mb-4">
                ...
                <form name="sentMessage"  method="post">
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Blood:</label>
                           <td><select name="blood"  required data-validation-required-message="Please select blood."><option selected="selected" value="" hidden="">Select</option>
                                      <?php 
                     ...
                     <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" id="email" name="nat" required data-validation-required-message="Please enter your nationality.">
                        </div>
                    </div>
