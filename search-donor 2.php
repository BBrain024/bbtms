...
<head>
    ...
    <title>Blood Bank & Transpalnting Management System | Become A Donor</title>
...
<?php include('includes/header - Osearch.php');?>
...
{
$status=1;
$transplant=$_POST['Organ'];
$location=$_POST['location'];
$sql = "SELECT * from tblorgandonars where (status=:status and Organ=:Organ) ||  (Address=:location)";
$query = $dbh -> prepare($sql);
$query->bindParam(':status',$status,PDO::PARAM_STR);
$query->bindParam(':Organ',$transplant,PDO::PARAM_STR);
