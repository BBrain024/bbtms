...
$sql="INSERT INTO  o_collector(Name,uniqueID,Email,gender,department,mobileno,password) VALUES('$fullname','$unique','$Email','$gender','$department','$mobile','$password')";
...
<head>
	...
	<title>BBOTS| Admin Add Collector</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Collector</h2>
...
<label class="col-sm-2 control-label"> Unique Id <span style="color:red">*</span></label>
<div class="col-sm-4">
