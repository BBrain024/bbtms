...
<head>
	...
	<title>BBOTS | Admin Dashboard</title>
...
<?php 
$sql ="SELECT id from tbltranstype ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Listed Organ Types</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql1 ="SELECT id from tblorgandonars ";
...
$sql6 ="SELECT id from tblcontactus ";
