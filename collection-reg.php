...
try {
    $message = $client->message()->send([
        'to' =>$_POST['Tele'],
        'from' => 'BBOTS',
        'text' => 'We are greatful for your donation.<br >THANK YOU for saving lives'
    ]);
  ...
  <h1>Register</h1>
	...
	<table>
			...
			<tr>
				...
				<td><input type="text" name="Cname"  required><br><br><br><br></td>
			</tr>
       ...
       <tr>
			...
			<tr>
				<td>Blood Tag No:<span style="color:red">*</span><br><br></td>
				<td><input type="text" name="tag" required><br><br>
				</td>
			</tr>
		
			<tr>
				<td>Blood Vloume:<span style="color:red">*</span><br><br></td>
				<td><input type="text" name="Bvolume" required><br><br>
				</td>
			</tr>
			
			<tr>
				<td>Date of Collection:<span style="color:red">*</span><br><br></td>
				<td><input type="Date" name="Cdate" required><br><br></td>
			</tr>
			
				<tr>
				<td>Telephone No:<span style="color:red">*</span><br><br></td>
				<td><input type="number" name="Tele" required><br><br>
				</td>
			</tr>

				<tr>
				<td>Date of Expiry:<span style="color:red">*</span><br><br></td>
				<td><input type="Date" name="Edate" required ><br><br></td>
			</tr>
