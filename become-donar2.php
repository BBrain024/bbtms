...
$status=1;
$sql="INSERT INTO  tblorgandonars(FullName,MobileNumber,EmailId,Age,Gender,Organ,Address,Message,status) VALUES(:fullname,:mobile,:email,:age,:gender,:organ,:address,:message,:status)";
...
<head>
    ...
    <title>BloodBank & transplanting System | Become A Donor</title>
...
<?php include('includes/header - Odonor.php');?>
