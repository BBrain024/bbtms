...
<div class="menu-area">
<li s><a href="../index.php">Back</a></li>
</div>
	</div>
	<div class="welcome2-text">
		<h2>Please Which type of collection?</h2>
		<button class="btn btn-1"><a href="B-choice.php">Blood</a> </button>
		<button class="btn btn-2"><a href="O-choice.php">Organ</a> </button>
	</div>
</header>
